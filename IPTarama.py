...
try:
	...
	if ilkIP<sonIP: #Kullanıcının girdiği ilk IP'nin son IP'den küçük olduğunu onaylamak için bu koşulu belirttik
		...
		print("İlk IP değeri son IP değerinden büyük olmalıdır.")
